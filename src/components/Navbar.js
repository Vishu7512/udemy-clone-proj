    ...
    <NavbarWrapper className = "bg-white flex">
      <div className='container w-100'>
        <div className='brand-and-toggler flex flex-between w-100'>
          ...
          <Link to='/Login' ><button type = "button" className='login-btn bg-purple text-white fw-6'>login</button> </Link>
          <Link to='/Admin' ><button type = "button" className='btn-btn bg-purple text-white fw-6'>Admin</button> </Link>
